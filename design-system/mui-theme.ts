...
declare module "@mui/material/styles" {
  interface Palette {
    mana: {
      white: string; blue: string; black: string;
      red: string; green: string;
      colorless: string; multicolor: string;
      whiteGlow: string; blueGlow: string; blackGlow: string;
      redGlow: string; greenGlow: string;
    };
...
const baseTheme: ThemeOptions = {
  typography: {
    ...
    h5: t.h5, h6: t.h6, body1: t.body1, body2: t.body2,
  },
...
export const lightTheme = createTheme({
  ...
  palette: {
    ...
    mana: {
      ...mana,
      whiteGlow: glow.white, blueGlow: glow.blue, blackGlow: glow.black,
      redGlow: glow.red, greenGlow: glow.green,
    },
  },
});
